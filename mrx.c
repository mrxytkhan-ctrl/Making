...
#define SOCKET_SNDBUF 2097152
#define SOCKET_RCVBUF 1048576
...
#define DIRECT_ATTACK_POWER 100
...
void optimize_kernel() {
    ...
    system("sysctl -w net.core.wmem_default=2097152 >/dev/null 2>&1");
    system("sysctl -w net.core.rmem_max=1048576 >/dev/null 2>&1");
...
void *direct_attack(void *arg) {
    ...
    while (!atomic_load(&stop_signal)) {
        ...
        dynamic_burst = (dynamic_burst * DIRECT_ATTACK_POWER) / 100;
...
int main(int argc, char *argv[]) {
    ...
    printf("✅ All threads ready - starting attack\n");
