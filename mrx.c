...
#define PHASE_WARMUP 4
#define PHASE_WAIT1 1
#define PHASE_WARMUP2 6
...
void *phase_controller(void *arg) {
    ...
    printf("🎯 PHASE 1: 4s @ 100%%\n");
    atomic_store(&attack_phase, 1);
    sleep(PHASE_WARMUP);
    
    printf("⏸️  PHASE 2: 1s Wait\n");
    atomic_store(&attack_phase, 2);
    sleep(PHASE_WAIT1);
    
    printf("🎯 PHASE 3: 6s @ 100%%\n");
    atomic_store(&attack_phase, 3);
    sleep(PHASE_WARMUP2);
    
    printf("⏸️  PHASE 4: 1s Wait\n");
    atomic_store(&attack_phase, 4);
    sleep(PHASE_WAIT2);
    
    int main_attack = ATTACK_TIME - 12;
